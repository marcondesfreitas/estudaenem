                  ...
                  <div class='tudo'>
                    ...
                    <fieldset id='meuMenu'>
                        ...
                        <div class='formulario'>
                          <form action='../adicionar/add_filosofia.php' enctype='multipart/form-data' method='POST'>
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    if (mysqli_num_rows($result) > 0) {
      while($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<form action='../editar_pg/edt_filosofia.php' method='post' style='display:inline;'>"; // Adicionar o formulário de edição
...
if (isset($_POST['apagar'])) {
  ...
  if(isset($_POST['id'])) {
    ...
    $sql = "DELETE FROM filosofia WHERE id = $id";
    $result = mysqli_query($conn, $sql);
    if ($result) {
    } else {
